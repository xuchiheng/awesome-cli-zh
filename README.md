...
| 平台 | CLI 名称 | 安装方式 | Stars | 语言 | 功能 | 链接 | 验证状态 | 需登录 | 说明 |
|------|---------|---------|-------|------|------|------| --- | --- | --- |
| 飞书 | `lark` | `npm install -g @larksuite/cli` | ~7.7k | Go | 飞书官方 CLI，200+ 命令覆盖 IM/文档/多维表格/日历/邮件/任务/会议等 14 个业务域 | [larksuite/cli](https://github.com/larksuite/cli) | [✅ 详情](tools/official/enterprise/lark/README.md) | ✅ | 实际命令为 `lark-cli`，建议用 `npx` |
...
| 平台 | CLI 名称 | 安装方式 | 功能 | 链接 | 验证状态 | 需登录 | 说明 |
|------|---------|---------|------|------| --- | --- | --- |
| 微信 | `miniprogram-ci` | `npm install miniprogram-ci` | 上传、预览、代码包管理 | [官方文档](https://developers.weixin.qq.com/miniprogram/dev/devtools/ci.html) | [✅ 详情](tools/official/miniprogram/miniprogram-ci/README.md) | ❌ | 全局命令未自动注入 PATH，建议用 `npx` |
| 支付宝 | `minidev` | `npm install -g minidev` | 上传、预览、沙箱调试 | [官方文档](https://opendocs.alipay.com/mini/02q29z) | [✅ 详情](tools/official/miniprogram/minidev/README.md) | ❌ | 全局命令未自动注入 PATH，建议用 `npx` |
...
| 厂商 | CLI 名称 | 安装方式 | Stars | 语言 | 功能 | 链接 | 验证状态 | 需登录 | 说明 |
|------|---------|---------|-------|------|------|------| --- | --- | --- |
| 七牛云 | `qshell` | 下载二进制 | ~1k | Go | 文件上传/下载/管理、CDN 管理、音视频处理 | [qiniu/qshell](https://github.com/qiniu/qshell) | [✅ 详情](tools/official/cloud/qshell/README.md) | ✅ | 需七牛云 AK/SK |
| 又拍云 | `upx` | `go install` / Scoop / Docker | ~200 | Go | 文件上传/下载/管理，支持 Mac/Linux/Windows | [upyun/upx](https://github.com/upyun/upx) | [✅ 详情](tools/official/cloud/upx/README.md) | ✅ | 需又拍云 operator 密码 |
| 阿里云 | `aliyun` | `brew install aliyun-cli` | ~940 | Go | 通用云平台 CLI，Apache 2.0 | [aliyun/aliyun-cli](https://github.com/aliyun/aliyun-cli) | [✅ 详情](tools/official/cloud/aliyun/README.md) | ✅ | 需阿里云 AccessKey |
| 腾讯云 | `tccli` | `pip install tccli` | ~117 | Python | 通用云平台 CLI，Apache 2.0 | [TencentCloud/tencentcloud-cli](https://github.com/TencentCloud/tencentcloud-cli) | [✅ 详情](tools/official/cloud/tccli/README.md) | ✅ | 需腾讯云 SecretId/Key |
| UCloud | `ucloud` | `brew install ucloud` | ~97 | Go | 通用云平台 CLI，Apache 2.0 | [ucloud/ucloud-cli](https://github.com/ucloud/ucloud-cli) | ⏳ | — | — |
| 京东云 | `jdc` | `pip install -U jdcloud_cli` | ~86 | Python | 通用云平台 CLI，Apache 2.0 | [jdcloud-api/jdcloud-cli](https://github.com/jdcloud-api/jdcloud-cli) | [✅ 详情](tools/official/cloud/jdc/README.md) | ✅ | 需京东云 AK/SK |
...
| 公司 | CLI 名称 | 安装方式 | Stars | 功能 | 链接 | 验证状态 | 需登录 | 说明 |
|------|---------|---------|-------|------|------| --- | --- | --- |
| 阿里通义千问 | `qwen-code` | `npm install -g @qwen-code/qwen-code@latest` / `brew install qwen-code` | ~20.7k | AI 编程 Agent，fork 自 Gemini CLI，支持 MCP、IDE 集成 | [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) | [✅ 详情](tools/official/ai/qwen-code/README.md) | ✅ | 需通义 API Key；命令为 `qwen` |
| Moonshot (Kimi) | `kimi-cli` | `uv tool install kimi-cli` | ~7.8k | AI 编程 Agent，代码编辑/Shell/Web 搜索/MCP，支持 VS Code / Zed / JetBrains | [MoonshotAI/kimi-cli](https://github.com/MoonshotAI/kimi-cli) | [✅ 详情](tools/official/ai/kimi-cli/README.md) | ✅ | 需 Moonshot API Key；`pip install kimi-cli` 在 PyPI 无对应包 |
| MiniMax | `mmx-cli` | `npm install -g mmx-cli` | — | AI 平台 CLI，全模态：文本/图像/视频/语音/音乐生成 | [MiniMax-AI/cli](https://github.com/MiniMax-AI/cli) | [✅ 详情](tools/official/ai/mmx-cli/README.md) | ✅ | 需 MiniMax API Key |
| 百度千帆 | `qianfan` | `pip install qianfan` | — | AI 平台 CLI，chat/completion/txt2img、数据集、训练、评估 | [baidubce/bce-qianfan-sdk](https://github.com/baidubce/bce-qianfan-sdk) | [✅ 详情](tools/official/ai/qianfan/README.md) | ✅ | 需千帆 AK/SK 或 App Key |
...
| 平台 | 项目名 | 安装方式 | Stars | 语言 | 功能 | 链接 | 验证状态 | 需登录 | 说明 |
|------|--------|---------|-------|------|------|------| --- | --- | --- |
...
| 小红书 | `xiaohongshu-cli` | `uv tool install xiaohongshu-cli` / `pipx install xiaohongshu-cli` | ~1.6k | Python | 搜索笔记、阅读、点赞、收藏、评论、发布，QR 码登录 | [jackwener/xiaohongshu-cli](https://github.com/jackwener/xiaohongshu-cli) | [✅ 详情](tools/third-party/content/xiaohongshu-cli/README.md) | ✅ | QR 码或浏览器 Cookie；与 xhs-cli 命令冲突 |
| 小红书 | `xhs-cli` | `uv tool install xhs-cli` / `pipx install xhs-cli` | ~439 | Python | 搜索、阅读、点赞、收藏、评论，Chrome Cookie 提取 | [jackwener/xhs-cli](https://github.com/jackwener/xhs-cli) | [✅ 详情](tools/third-party/content/xhs-cli/README.md) | ✅ | QR 码或浏览器 Cookie；与 xiaohongshu-cli 冲突 |

#### 视频

| 覆盖平台 | 项目名 | 安装方式 | Stars | 语言 | 功能 | 链接 | 验证状态 | 需登录 | 说明 |
|---------|--------|---------|-------|------|------|------| --- | --- | --- |
| B站/优酷/爱奇艺/搜狐/网易等 | `you-get` | `pip install you-get` / `brew install you-get` | ~56.8k | Python | 多平台视频/音频/图片下载 | [soimort/you-get](https://github.com/soimort/you-get) | [✅ 详情](tools/third-party/video/you-get/README.md) | ❌ | 部分站点需 cookies |
...
| 平台 | 项目名 | 安装方式 | Stars | 语言 | 功能 | 链接 | 验证状态 | 需登录 | 说明 |
|------|--------|---------|-------|------|------|------| --- | --- | --- |
| 语雀 | `yuque-tools` | npm / 下载可执行文件 | ~542 | TypeScript | 语雀知识库+团队资源批量导出/备份（无需 Token） | [vannvan/yuque-tools](https://github.com/vannvan/yuque-tools) | [✅ 详情](tools/third-party/other/yuque-tools/README.md) | ✅ | 实际命令为 `ytool`，建议用 `npx` |
...
| 项目名 | 安装方式 | Stars | 语言 | 功能 | 链接 | 验证状态 | 需登录 | 说明 |
|--------|---------|-------|------|------|------| --- | --- | --- |
| wechaty | `npm install wechaty` | ~22.7k | TypeScript | 跨平台聊天机器人 RPA SDK，微信/企微/WhatsApp | [wechaty/wechaty](https://github.com/wechaty/wechaty) | [✅ 详情](tools/third-party/wechat/wechaty/README.md) | ✅ | 需 Puppet Provider / Token；建议用 `npx` |
...
| 项目名 | 安装方式 | Stars | 语言 | 功能 | 链接 | 验证状态 | 需登录 | 说明 |
|--------|---------|-------|------|------|------| --- | --- | --- |
| `md-cli` (doocs/md) | `npm i -g @doocs/md-cli` | ~12.3k | Vue | Markdown 转微信公众号文章、自定义主题、AI 助手 | [doocs/md](https://github.com/doocs/md) | [✅ 详情](tools/third-party/wechat/md-cli/README.md) | ❌ | 启动本地 Web 服务 |

### 音乐与娱乐

| 平台 | 项目名 | 安装方式 | Stars | 语言 | 功能 | 链接 | 验证状态 | 需登录 | 说明 |
|------|--------|---------|-------|------|------|------| --- | --- | --- |
| 网易云音乐 | `musicbox` | `pip3 install NetEase-MusicBox` / `brew install musicbox` | ~9.8k | Python | 命令行音乐播放器：排行榜/搜索/歌单/登录/DJ/歌词 (已归档) | [darknessomi/musicbox](https://github.com/darknessomi/musicbox) | [✅ 详情](tools/third-party/music/musicbox/README.md) | ✅ | 项目已归档，部分 API 可能失效 |
| 网易云/QQ/酷狗/酷我/咪咕等 | `musicdl` | `pip install musicdl` | ~4k | Python | 轻量级无损音乐下载器，支持数十个音乐平台 | [CharlesPikachu/musicdl](https://github.com/CharlesPikachu/musicdl) | [✅ 详情](tools/third-party/music/musicdl/README.md) | ❌ | 部分平台需 cookies |
...
| 翻译 | `fanyi` | `npm i fanyi -g` | ~1.5k | Node.js | 中英翻译 CLI，集成 iciba + DeepSeek AI | [afc163/fanyi](https://github.com/afc163/fanyi) | [✅ 详情](tools/third-party/internet/fanyi/README.md) | ❌ | DeepSeek 需 API Key |
| 搜索 | open-webSearch | `npm run search:cli` | ~976 | — | 多引擎搜索（Bing/Baidu/DuckDuckGo），CLI / HTTP / MCP 三模式 | [Aas-ee/open-webSearch](https://github.com/Aas-ee/open-webSearch) | [✅ 详情](tools/third-party/internet/open-websearch/README.md) | ❌ | 需先启动 daemon `serve` |
